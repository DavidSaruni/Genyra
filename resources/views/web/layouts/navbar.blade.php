    ...
    <div id="mobile-about-submenu" class="fixed top-0 right-0 h-full w-full bg-white z-[60] md:hidden transform translate-x-full transition-transform duration-300 ease-in-out overflow-y-auto">
        ...
        <div class="px-4 py-6">
            ...
            <div class="mb-8">
                ...
                <div class="space-y-1">
                    <a href="{{ route('directors') }}" class="block px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors">Board of Directors</a>
                    <a href="{{ route('management') }}" class="block px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors">Management Team</a>
                </div>
            </div>
