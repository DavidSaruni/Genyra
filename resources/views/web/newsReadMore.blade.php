    ...
    <aside class="w-full lg:w-80 flex-shrink-0 flex flex-col gap-5">
      ...
      <div class="bg-white rounded shadow-[0_1px_4px_rgba(0,0,0,0.07)] overflow-hidden">
        ...
        <div class="divide-y divide-[#f0f4f8]">
          ...
          <a href="#" class="block p-4 hover:bg-[#f0f4f8] transition-colors no-underline group">
            <div class="flex gap-3">
              <img src="https://images.pexels.com/photos/3184292/pexels-photo-3184292.jpeg?auto=compress&cs=tinysrgb&w=120" alt="Related" class="w-20 h-20 object-cover rounded flex-shrink-0" />
              <div class="flex-1 min-w-0">
                <div class="text-[0.65rem] text-[#00a0c6] font-semibold uppercase tracking-wider mb-1">Health Systems</div>
                <h4 class="text-sm font-semibold text-[#1e3a6e] group-hover:text-[#00a0c6] transition-colors line-clamp-2 leading-snug">
                  Integrated HIS/LIS Successfully Deployed Across 300-Bed Hospital
                </h4>
                <div class="text-xs text-[#6b7280] mt-1">10 Feb 2026</div>
              </div>
            </div>
          </a>
          ...
          <a href="#" class="block p-4 hover:bg-[#f0f4f8] transition-colors no-underline group">
            <div class="flex gap-3">
              <img src="https://images.pexels.com/photos/4225880/pexels-photo-4225880.jpeg?auto=compress&cs=tinysrgb&w=120" alt="Related" class="w-20 h-20 object-cover rounded flex-shrink-0" />
              <div class="flex-1 min-w-0">
                <div class="text-[0.65rem] text-[#00a0c6] font-semibold uppercase tracking-wider mb-1">Calibration</div>
                <h4 class="text-sm font-semibold text-[#1e3a6e] group-hover:text-[#00a0c6] transition-colors line-clamp-2 leading-snug">
                  Genyra Metrology Lab Achieves ISO/IEC 17025:2017 Accreditation
                </h4>
                <div class="text-xs text-[#6b7280] mt-1">3 Feb 2026</div>
              </div>
            </div>
          </a>
          ...
          <a href="#" class="block p-4 hover:bg-[#f0f4f8] transition-colors no-underline group">
            <div class="flex gap-3">
              <img src="https://images.pexels.com/photos/2280571/pexels-photo-2280571.jpeg?auto=compress&cs=tinysrgb&w=120" alt="Related" class="w-20 h-20 object-cover rounded flex-shrink-0" />
              <div class="flex-1 min-w-0">
                <div class="text-[0.65rem] text-[#00a0c6] font-semibold uppercase tracking-wider mb-1">BioSciences</div>
                <h4 class="text-sm font-semibold text-[#1e3a6e] group-hover:text-[#00a0c6] transition-colors line-clamp-2 leading-snug">
                  Genyra BioSciences Supports KEMRI in Translational Research
                </h4>
                <div class="text-xs text-[#6b7280] mt-1">20 Jan 2026</div>
              </div>
            </div>
          </a>
      ...
      <div class="bg-white rounded shadow-[0_1px_4px_rgba(0,0,0,0.07)] overflow-hidden">
        ...
        <div>
          <a href="#" class="flex justify-between items-center px-4 py-2 border-b border-[#f0f4f8] text-[0.82rem] font-normal text-[#374151] hover:bg-[#eaf6fb] hover:text-[#1e3a6e] transition-all no-underline last:border-b-0">
          ...
          <a href="#" class="flex justify-between items-center px-4 py-2 text-[0.82rem] font-normal text-[#374151] hover:bg-[#eaf6fb] hover:text-[#1e3a6e] transition-all no-underline">
      ...
      {{-- Newsletter Signup --}}
      <div class="bg-gradient-to-br from-[#1e3a6e] to-[#0077b6] rounded-lg shadow-lg p-6 text-white">
        <h3 class="text-lg font-bold mb-2">Stay Updated</h3>
        <p class="text-sm text-white/90 mb-4">Subscribe to our newsletter for the latest healthcare technology news and updates.</p>
        <div class="space-y-3">
          <input type="email" placeholder="Your email address" class="w-full px-4 py-2 rounded text-sm text-[#374151] focus:outline-none focus:ring-2 focus:ring-[#00a0c6]" />
          <button class="w-full bg-[#00a0c6] hover:bg-[#b3e8f5] text-white hover:text-[#1e3a6e] py-2 px-4 rounded font-medium text-sm transition-colors">
            Subscribe Now
          </button>
        </div>
        <p class="text-xs text-white/70 mt-3">We respect your privacy. Unsubscribe at any time.</p>
      </div>
