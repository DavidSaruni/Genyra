...
<div class="max-w-6xl">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
            ...
            <div class="text-2xl font-bold text-slate-900">{{ $totalSent }}</div>
            <p class="text-xs text-slate-500 mt-1">Total emails sent</p>
        </div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
            ...
            <div class="text-2xl font-bold text-slate-900">{{ $totalRecipients }}</div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
            ...
            <div class="text-2xl font-bold text-slate-900">{{ $totalAttachments }}</div>
                        ...
                        <div class="border border-slate-200 rounded-lg p-4 hover:bg-slate-50 transition-colors">
                            ...
                            <div class="text-sm text-slate-600 space-y-2">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span>Attachments: {{ $email->attachment_count }} files</span>
                                </div>
                            </div>
                        </div>
                    @endforeach
