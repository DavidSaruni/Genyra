...
<div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:1.5rem; flex-wrap:wrap; gap:0.75rem;">
    <div>
        <h1 style="font-size:1.1rem; font-weight:700; color:#0f172a; margin:0;">Create News Article</h1>
        <p style="font-size:0.78rem; color:#64748b; margin:0.2rem 0 0;">Fill in the details below to publish a new article</p>
    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <textarea id="excerpt" name="excerpt" rows="3"
                    class="form-input" placeholder="Write a brief summary...">{{ old('excerpt') }}</textarea>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div style="margin-bottom:1.1rem;">
                    <label for="main_image" class="field-label">Main Image <span style="color:#ef4444;">*</span></label>
            ...
            <div class="card-body" style="display:flex; flex-direction:column; gap:1rem;">
                ...
                <div>
                    ...
                    <input type="number" id="read_time" name="read_time" min="1" max="30"
                        value="{{ old('read_time', 5) }}" class="form-input" placeholder="5">
...
<div style="background:#fff; border-radius:8px; border:1px solid #e2e8f0; padding:1rem 1.25rem; display:flex; align-items:center; justify-content:flex-end; gap:0.75rem; margin-top:0.5rem; box-shadow:0 1px 4px rgba(0,0,0,0.05);">
    ...
    <button type="submit"
        style="padding:0.6rem 1.5rem; background:#1e3a6e; color:#fff; border:none; border-radius:6px; font-size:0.82rem; font-weight:600; cursor:pointer; transition:background 0.15s;"
